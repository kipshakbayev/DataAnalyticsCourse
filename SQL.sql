...
ALTER TABLE temp_staff DROP COLUMN password;
...
WHERE description REGEXP "^A Thoughtful";
...
WHERE description REGEXP 'Database' AND length > 180;
...
SELECT a.first_name AS customer_first_name, b.last_name AS actor_last_name
FROM customer AS a
LEFT JOIN actor as b
ON a.customer_id = b.actor_id;
...
SELECT a.first_name, a.last_name, b.address, b.address2, c.city, b.district, b.postal_code
FROM staff AS a
